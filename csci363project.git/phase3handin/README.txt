...
Note:
Since our programming structure for phase 2 was made in a way such that it was tightly 
fitted to parsing htmls and xmls from the internet through HTTP GET, trying to fit in pdf
and txt parsing capability broke our program too many times. As a result, we were forced to
run a separate crawler which took care of pdf and txt cases in the list of visited pages.
