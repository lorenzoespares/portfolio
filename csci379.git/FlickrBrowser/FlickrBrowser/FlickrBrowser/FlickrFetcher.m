...
//
// Retrieves an array of Bucknell photos.  Unfortunately, the photos don't have
// descriptive names or owners.
//
+ (NSArray *)bucknellPhotos {
    NSString *request = @"http://api.flickr.com/services/rest/?"
